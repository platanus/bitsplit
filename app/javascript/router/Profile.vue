<template>
  <div>
    <h1>Base del perfil de usuario</h1>
    <!-- Quizas los botones ponerlos en un menu lateral si se ve bien (algo asi https://tailwindcomponents.com/component/app-sidebar)-->
    <div class="bg-white">
