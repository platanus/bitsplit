...
export default {
  ...
  [GET_USER_BUDA_BALANCE_SUCCESS](state, balance) {
    state.getBalanceLoading = false;
    state.userBudaBalance = {
      CLP: parseFloat(balance.CLP.available_amount),
      BTC: parseFloat(balance.BTC.available_amount),
    };
  },
